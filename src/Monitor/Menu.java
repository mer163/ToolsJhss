...
//			button1.setBounds(860, 480, 200, 35);  
		    frame.add(button1);
		    
//		    final JButton btnAuto = new JButton("自动化测试");
//		    btnAuto.setBounds(860, 520, 200, 35);  
//		    frame.add(btnAuto);
...
//				@Override
//				public void actionPerformed(ActionEvent e) {
//					Automation_Menu m = null;
//					try {
//						m = new Automation_Menu();
//					} catch (IOException e1) {
//						// TODO Auto-generated catch block
//						e1.printStackTrace();
//					}
